...
var getPieData = d3.pie().value(function (d) {
  return d.value;
});
...
var arcCreator = d3.arc().innerRadius(0).outerRadius(HEIGHT / 2);
...
var pie = svg.append('g').attr('transform', "translate(".concat(HEIGHT / 2, ", ").concat(HEIGHT / 2, ")"));
pie.selectAll('path').data(pieData).enter().append('path').attr('d', arcCreator).attr('fill', color);
